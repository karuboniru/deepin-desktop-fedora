# parallel build occationally fails
...
sed -i '/greeter-display-daemon/s|lib|libexec|' Makefile
# Fix fallback session script path (RHBZ#1706281)
#qsed -i 's|/usr/sbin/lightdm-session|%{_sysconfdir}/X11/xinit/Xsession|' misc/deepin-session
